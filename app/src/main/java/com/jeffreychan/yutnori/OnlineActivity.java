...
//		findViewById(R.id.sign_in_button).setOnClickListener(this);
	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		...
		if (mSignInClicked || mAutoStartSignInFlow) {
			...
			mResolvingConnectionFailure = BaseGameUtils.resolveConnectionFailure(this,
					client, connectionResult, RC_SIGN_IN,
	...
	public void onCancelClicked(View view) {
		showSpinner();
		Games.TurnBasedMultiplayer.cancelMatch(client, mMatch.getMatchId())
	...
	public void onLeaveClicked(View view) {
		...
		Games.TurnBasedMultiplayer.leaveMatchDuringTurn(client, mMatch.getMatchId(),
	...
	public void onFinishClicked(View view) {
		showSpinner();
		Games.TurnBasedMultiplayer.finishMatch(client, mMatch.getMatchId())
	...
	public void onDoneClicked(View view) {
		...
		Games.TurnBasedMultiplayer.takeTurn(client, mMatch.getMatchId(),
	...
	public void setViewVisibility() {
		boolean isSignedIn = (client != null) && (client.isConnected());
	...
	public void onActivityResult(int request, int response, Intent data) {
		...
		if (request == RC_SIGN_IN) {
			...
			// Start the match
			Games.TurnBasedMultiplayer.createMatch(client, tbmc).setResultCallback(
	...
	public void startMatch(TurnBasedMatch match) {
		...
		Games.TurnBasedMultiplayer.takeTurn(client, match.getMatchId(),
	...
	public void rematch() {
		showSpinner();
		Games.TurnBasedMultiplayer.rematch(client, mMatch.getMatchId()).setResultCallback(
				new ResultCallback<TurnBasedMultiplayer.InitiateMatchResult>() {
					@Override
					public void onResult(TurnBasedMultiplayer.InitiateMatchResult result) {
						processResult(result);
	...
	public void updateMatch(TurnBasedMatch match) {
		...
		switch (turnStatus) {
			case TurnBasedMatch.MATCH_TURN_STATUS_MY_TURN:
				mTurnData = OnlineTurn.unpersist(mMatch.getData());
				setGameplayUI();
				return;
